<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Item Accepted by Courier","Ready to Pickup","Picked-up","Shipped","In-Transit","Arrived At Destination","Collected","Out for Delivery","Delivered","Unsuccessfull Delivery Attempt"); ?>
