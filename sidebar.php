        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Item Accepted by Courier","Ready to Pickup","Picked-up","Shipped","In-Transit","Arrived At Destination","Collected","Out for Delivery","Delivered","Unsuccessfull Delivery Attempt");
